...
const tempatpkl = computed(() => storeAdminAuth.tempatpkl);
...
const getDataDetail = async () => {
  try {
    const response = await Api.post(`pembimbinglapangan/auth/profile`);
    ...
    storeAdminAuth.setTempatpkl(response.data.tempatpkl)
        ...
        <div>
          <div class="flex flex-col justify-center w-full">
            ...
            <div class="flex justify-center flex-col">
              ...
              <p class="text-base-content text-sm font-medium text-center link link-primary" v-if="tempatpkl">
                {{ tempatpkl.nama }}
              </p>
